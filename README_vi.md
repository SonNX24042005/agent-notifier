...
```powershell
irm https://raw.githubusercontent.com/SonNX24042005/agent-notifier/master/scripts/update.ps1 | iex
```

### Trên Linux

```bash
curl -fsSL https://raw.githubusercontent.com/SonNX24042005/agent-notifier/master/scripts/update.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/SonNX24042005/agent-notifier/master/scripts/uninstall.ps1 | iex
```

### Trên Linux

```bash
curl -fsSL https://raw.githubusercontent.com/SonNX24042005/agent-notifier/master/scripts/uninstall.sh | bash
```
...
├── bin/
│   ├── anoti                     # Công cụ dòng lệnh CLI thống nhất
│   ├── anoti.cmd                 # Wrapper cho Windows Command Prompt
│   ├── anoti.ps1                 # Wrapper cho PowerShell
│   └── multi-desktop-notify.py   # Engine hiển thị overlay đa màn hình, toast và focus
│   ├── architecture.md           # Tài liệu kiến trúc và hướng dẫn mở rộng
│   └── windows-guide.md          # Hướng dẫn chi tiết cho người dùng Windows
├── hooks/
│   ├── claude-notify.py          # Kịch bản hook cho Claude Code (đa nền tảng)
│   ├── claude-notify.sh          # Kịch bản hook cho Claude Code (Linux)
│   ├── codex-notify.py           # Kịch bản hook cho OpenAI Codex (đa nền tảng)
│   ├── antigravity-notify.py     # Kịch bản hook cho Google Antigravity (đa nền tảng)
│   └── antigravity-notify.sh     # Kịch bản hook cho Google Antigravity (Linux)
├── gnome-shell-extension/        # Adapter focus cửa sổ Wayland trên GNOME Shell
├── scripts/
